                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="POST" action="addDesignationData.php">
                                    ...
                                    <div class="text-right">
                                        <a href="./designationList.php" class="back_btn">Back to List</a>
                                        <button type="submit" class="submit_btn" name="designation-save">Add New Designation </button>
                                    </div>
                                </form>
                                <!-- form end -->
