						...
						<div class="panel-heading">
							...
							<div class="panel-body">
                                ...
                                <?php
									...
									$id =$_GET["designation_id"];
                                    $fetchQuery = "select * from designations where id = '{$id}'";
                                ...
                                <form class="form-horizontal" method="POST" action="updateDesignationData.php">
									...
									<div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" name="designation_name" id="designation_name" value="<?php echo $row['designation_name'] ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button type="submit" class="submit_btn" name="designation-update">Update Designation </button>
                                    </div>
                                </form>
								<!-- form end -->
								<?php 
