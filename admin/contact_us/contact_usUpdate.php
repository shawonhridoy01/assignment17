						...
						<div class="panel panel-flat">
							<div class="panel-body">
								...
								if (isset($_GET["contact_us_id"])) {
									$id =  $_GET["contact_us_id"];
								} else {
									header("location:contact_usList.php");
								}
								$id = $_GET["contact_us_id"];
								$fetchQuery = "select * from contact_us where id = '{$id}'";
								...
								?>
										...
										<form class="form-horizontal" method="POST" action="updateCategoriesData.php">
											...
											<div class="text-right">
												...
												<button type="submit" class="submit_btn" name="contact_us-update">Update Designation </button>
											</div>
										</form>
										<!-- form end -->
								<?php
