				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Update Contact Us</h5>
						...
						<div class="panel panel-flat">
							<div class="panel-body">
								...
								if (isset($_GET["contact_messages_id"])) {
									$id =  $_GET["contact_messages_id"];
								} else {
									header("location:contact_messagesList.php");
								}
								$id = $_GET["contact_messages_id"];
								$fetchQuery = "select * from contact_messages where id = '{$id}'";
										...
										<form class="form-horizontal" method="POST" action="updateCategoriesData.php">
											<fieldset class="content-group mt-10">
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input type="text" class="form-control" name="contact_topic" id="contact_topic" value="<?php echo $row['contact_topic'] ?>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input type="text" class="form-control" name="contact_details" id="contact_details" value="<?php echo $row['contact_details'] ?>">
													</div>
												</div>


												<div class="form-group">
													<label class="control-label col-lg-2" for="icon_name">Contact Icon Name</label>
													<div class="col-lg-10">
											...
											<div class="text-right">
												...
												<button type="submit" class="submit_btn" name="contact_messages-update">Update Designation </button>
											</div>
										</form>
										<!-- form end -->
								<?php
