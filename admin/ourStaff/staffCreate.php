                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="POST" action="./addStaffData.php" enctype="multipart/form-data">
                                    <fieldset class="content-group mt-10">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="file" class="form-control" name="staff_image" id="staff_image" required>
                                            </div>
                                        </div>
                                         -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" name="linkedin" id="linkedin" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button type="submit" class="submit_btn" name="staff-save">Add New Staff </button>
                                    </div>
                                </form>
                                <!-- form end -->
